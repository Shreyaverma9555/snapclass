...
def _bottom_showcase():
    st.markdown(
        ...
        <section class="snap-bottom-showcase"><div class="snap-bottom-showcase-label">The complete SnapClass experience</div><video autoplay muted loop playsinline preload="metadata" poster="__BOTTOM_POSTER__" aria-label="Animated SnapClass teacher, students and AI classroom showcase"><source src="__BOTTOM_VIDEO__" type="video/mp4"></video><div class="snap-bottom-visuals" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i></div></section>
        """.replace(
            "__BOTTOM_POSTER__", static_data_uri("snapclass-classroom-bottom.png")
        ).replace(
            "__BOTTOM_VIDEO__", static_data_uri("snapclass-classroom-animated.mp4")
        ),
        unsafe_allow_html=True,
    )
...
def home_screen():
    ...
    with col1:
        st.html(f'<div class="portal-role-head"><h2>I&apos;m Student</h2><img class="portal-mascot" src="{static_data_uri("student-mascot.png")}" alt="Student portal mascot"></div>')
    ...
    with col2:
        st.html(f'<div class="portal-role-head"><h2>I&apos;m Teacher</h2><img class="portal-mascot" src="{static_data_uri("teacher-mascot.png")}" alt="Teacher portal mascot"></div>')
